...
Integer id ;
    ...
    private void initComponents() {
        ...
        txtharga.setName("txthrg"); // NOI18N
...
//        Insert pembelian
        try {
            ...
            String input = "insert into pembelian(NoNota,TglNota,QtyNota,HrgNota,StockID) values "
                    + "('"+txtnonota.getText()+"','"+txttglnota.getText()+"',"+Integer.parseInt(txtqty.getText())+""
                    + ","+Double.parseDouble(txtharga.getText())+","+id+")";
...
//        Hapus data pembelian
        ...
        try {
            Statement stat = con.createStatement();
            String input = "delete from pembelian where nonota = '"+hapus+"'";
            stat.executeUpdate(input);
